...
const RestaurantCard = ({name, cuisines, avgRating, cloudinaryImageId,name1}) => {
    // const {name, cuisines, avgRating, cloudinaryImageId} = restaurant.info;
        ...
        <div className="w-52 rounded-xl ">
            ...
            <h2 className="text-lg font-bold whitespace-nowrap overflow-hidden text-ellipsis">{name}</h2>
            <h3 className="whitespace-nowrap overflow-hidden text-ellipsis">{cuisines.join(", ")}</h3>
